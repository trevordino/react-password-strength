...
class PasswordStrengthBar extends React.Component<PasswordStrengthBarProps, PasswordStrengthBarState> {
  ...
  public render(): ReactNode {
    const { className, style, scoreWordClassName, scoreWordStyle, password, barColors, scoreWords, minLength, shortScoreWord } = this.props;
    const { score } = this.state;
    const newShortScoreWord = password.length >= minLength ? scoreWords[score] : shortScoreWord;
